...
class MsckfVio {
  ...
  private:
    ...
    void leicaCallback(const geometry_msgs::PointStamped& msg);
    ...
    geometry_msgs::PointStamped leica_msg_buffer;
    float leica_offset_x = 0;
    float leica_offset_y = 0;
    float leica_offset_z = 0;
    bool is_first_leica = true;
